...
export type PartialCompletionModelArgs<
  ...
  CustomConfig extends Model.Completion.Config<CustomClient>,
> = Prettify<
  PartialDeep<Pick<CompletionModelArgs<Partial<CustomCtx>, CustomClient, CustomConfig>, 'params'>> &
    Partial<Omit<CompletionModelArgs<Partial<CustomCtx>, CustomClient, CustomConfig>, 'params'>>
>;

export class CompletionModel<
  CustomCtx extends Model.Ctx = Model.Ctx,
  CustomClient extends Model.Completion.Client = Model.Completion.Client,
  CustomConfig extends Model.Completion.Config<CustomClient> = Model.Completion.Config<CustomClient>,
...
> {
  ...
  constructor(args?: CompletionModelArgs<CustomCtx, CustomClient, CustomConfig>) {
    ...
    params = params ?? { model: 'gpt-3.5-turbo-instruct' } as CustomConfig & Partial<Model.Completion.Run>;
    super({ client, params, ...rest });
  }

  protected async runModel(
    { requestOpts, ...params }: Partial<Model.Completion.Run & Model.Completion.Config<CustomClient>>,
    context: CustomCtx
  ...
  extend(args?: PartialCompletionModelArgs<CustomCtx, CustomClient, CustomConfig>): this {
