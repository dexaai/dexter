...
[src/model/embedding.ts:48](https://github.com/dexaai/llm-tools/blob/f300435/src/model/embedding.ts#L48)

## Properties

| Property | Type | Description | Inheritance | Source |
| :------ | :------ | :------ | :------ | :------ |
| `modelProvider` | `"openai"` | - | [`AbstractModel`](AbstractModel.md).`modelProvider` | [src/model/embedding.ts:44](https://github.com/dexaai/llm-tools/blob/f300435/src/model/embedding.ts#L44) |
| `modelType` | `"embedding"` | - | [`AbstractModel`](AbstractModel.md).`modelType` | [src/model/embedding.ts:43](https://github.com/dexaai/llm-tools/blob/f300435/src/model/embedding.ts#L43) |
| `throttledModel` | `BulkEmbedder` | - | - | [src/model/embedding.ts:45](https://github.com/dexaai/llm-tools/blob/f300435/src/model/embedding.ts#L45) |
...
[src/model/embedding.ts:154](https://github.com/dexaai/llm-tools/blob/f300435/src/model/embedding.ts#L154)
