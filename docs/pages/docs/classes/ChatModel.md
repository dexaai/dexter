...
[src/model/chat.ts:29](https://github.com/dexaai/llm-tools/blob/5018eae/src/model/chat.ts#L29)

## Properties

| Property | Type | Description | Inheritance | Source |
| :------ | :------ | :------ | :------ | :------ |
| `modelProvider` | `"openai"` | - | [`AbstractModel`](AbstractModel.md).`modelProvider` | [src/model/chat.ts:27](https://github.com/dexaai/llm-tools/blob/5018eae/src/model/chat.ts#L27) |
| `modelType` | `"chat"` | - | [`AbstractModel`](AbstractModel.md).`modelType` | [src/model/chat.ts:26](https://github.com/dexaai/llm-tools/blob/5018eae/src/model/chat.ts#L26) |
...
[src/model/chat.ts:184](https://github.com/dexaai/llm-tools/blob/5018eae/src/model/chat.ts#L184)
