...
[src/model/sparse-vector.ts:33](https://github.com/dexaai/llm-tools/blob/eeaf162/src/model/sparse-vector.ts#L33)

## Properties

| Property | Type | Description | Inheritance | Source |
| :------ | :------ | :------ | :------ | :------ |
| `modelProvider` | `"custom"` | - | [`AbstractModel`](AbstractModel.md).`modelProvider` | [src/model/sparse-vector.ts:30](https://github.com/dexaai/llm-tools/blob/eeaf162/src/model/sparse-vector.ts#L30) |
| `modelType` | `"sparse-vector"` | - | [`AbstractModel`](AbstractModel.md).`modelType` | [src/model/sparse-vector.ts:29](https://github.com/dexaai/llm-tools/blob/eeaf162/src/model/sparse-vector.ts#L29) |
| `serviceUrl` | `string` | - | - | [src/model/sparse-vector.ts:31](https://github.com/dexaai/llm-tools/blob/eeaf162/src/model/sparse-vector.ts#L31) |
...
[src/model/sparse-vector.ts:105](https://github.com/dexaai/llm-tools/blob/eeaf162/src/model/sparse-vector.ts#L105)
